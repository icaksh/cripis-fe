...
import {editUserPassword, editUserProfile, user} from ".";
import {email, helpers, integer, required, sameAs} from "@vuelidate/validators";
    ...
    return {
      ...
      auth:{
        ...
        confirmPassword: {
          ...
          isConfirmed:
              helpers.withMessage("Password tidak sama", sameAs(this.auth.password))
        },
      }
    }
  },
        ...
        Swal.fire(
            {
              ...
              text: "Anda akan mengubah profil Anda",
              icon: "warning",
          ...
          if (result.isConfirmed) {
            editUserProfile(this.user).then(() => {
                ...
                err => {
                  Swal.fire({
                    title: "Gagal",
                    text: "Identitas gagal diubah, " + err.message,
                    icon: "error",
                    confirmButtonText: "OK",
                  })
                })
    ...
    handleUserEditPassword(){
      ...
      if(this.v$.auth.$invalid){
        ...
        Swal.fire(
            {
              title: "Apakah Anda yakin?",
              text: "Password akun Anda akan diubah",
              icon: "warning",
              showCancelButton: true,
              confirmButtonText: "Ya",
              cancelButtonText: "Tidak, Batalkan",
          ...
          if (result.isConfirmed) {
            editUserPassword(this.auth).then(() => {
                  Swal.fire({
                    title: "Berhasil",
                ...
                err => {
                  Swal.fire({
                    title: "Gagal",
                    text: "Password gagal diubah, " + err.message,
                    icon: "error",
                    confirmButtonText: "OK",
                  })
                })
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-body border-bottom">
            <div class="d-flex align-items-center">
              <h5 class="mb-0 card-title flex-grow-1">Ubah Profil Akun</h5>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body border-bottom">
            <div class="d-flex align-items-center">
              <h5 class="mb-0 card-title flex-grow-1">Ubah Password</h5>
            </div>
          </div>
          <div class="card-body">
                  <div class="row">
                      ...
                      <div class="row">
                        ...
                        >
                          <b-form-input
                              ...
                              @input="()=> { v$.auth.old_password.$touch();}"
                              :class="{
                    'is-invalid': v$.auth.old_password.$error,
                  }"
                          ></b-form-input>
                          <div
                              v-if="v$.auth.old_password.$error"
                              class="invalid-feedback"
                          >
                    <span v-if="v$.auth.old_password.required.$invalid">{{
                        v$.auth.old_password.required.$message
                      }}</span>
                          </div>
                        </b-form-group>
                      </div>
                      <div class="row">
                        ...
                        >
                          <b-form-input
                              ...
                              :class="{
                    'is-invalid': v$.auth.password.$error,
                  }"
                          ></b-form-input>
                          <div
                              v-if="v$.auth.password.$error"
                              class="invalid-feedback"
                          >
                    <span v-if="v$.auth.password.required.$invalid">{{
                      ...
                      <div class="row">
                        ...
                        >
                          <b-form-input
                              ...
                              :class="{
                    'is-invalid': v$.auth.confirmPassword.$error,
                  }"
                          ></b-form-input>
                          <div
                              v-if="v$.auth.confirmPassword.$error"
                              class="invalid-feedback"
                          >
                    <span v-if="v$.auth.confirmPassword.required.$invalid">{{
                        v$.auth.confirmPassword.required.$message
                      }}</span>
                            <span v-else-if="v$.auth.confirmPassword.isConfirmed">{{
                                v$.auth.confirmPassword.isConfirmed.$message
                              }}</span>
                          </div>
                        </b-form-group>
                      </div>
