...
export default {
  ...
  mounted(){
    ...
    if(this.value){
      this.document.signature = this.value.signature
      this.document.certificate = this.value.certificate
      this.document.preview.signature.show = true
      this.document.preview.signature.image = this.value.signature
      this.document.preview.certificate.show = true
      this.document.preview.certificate.image = this.value.certificate
      this.emitInput()
    }
        ...
        <div class="row mt-4">
          ...
          >
            <b-form-file
                ...
                v-model="document.new_signature"
        ...
        <div class="row mt-4">
          ...
          >
            <b-form-file
                ...
                v-model="document.new_certificate"
    ...
    <div class="col-lg-6">
      <div class="card-body">
        ...
        <div v-if="document.preview.certificate.show">
          <h4 class="card-title mt-4">Surat Keterangan Usaha</h4>
          <div class="mt-4">
