...
export default {
  ...
  created() {
    if(this.value){
      this.trademark.name = this.value.name
      this.trademark.class = this.value.class
      this.trademark.image = this.value.image
      this.trademark.preview.show = true
      this.trademark.preview.image = this.value.image
      this.emitInput()
    }
