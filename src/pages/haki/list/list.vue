...
import {getDak, getTrademarkClasses, getTrademarks, getTrademarkStatus} from "@/pages/haki/register/helpers";
import {ref} from "vue";
    ...
    async exportToCSV() {
      ...
      for (let i = 0; i < this.trademarks.length; i++) {
        ...
        data.push({
          ...
          "Tanggal Diterbitkan": this.trademarks[i].approved_at.Valid ? moment(this.trademarks[i].approved_at.String).format("DD-MM-YYYY") : "BELUM DITERBITKAN",
          "Tanggal Berakhir Masa Perlindungan": this.trademarks[i].expired_at.Valid ? moment(this.trademarks[i].expired_at.String).format("DD-MM-YYYY") : "BELUM DITERBITKAN",
      ...
      <div class="col-sm-6 col-md-4 col-xl-3">
        <div class="my-4 text-center">
          ...
          <b-modal
              v-model="isOpenNotes"
              id="modal-standard"
              title="Keterangan Hak Cipta"
              title-class="font-18"
          >
            <span v-if="isOpenNotes">{{ trademarkModel.notes.String }}</span>
          </b-modal>
        </div>
      </div>
    </div>
          ...
          <div class="card-body border-bottom">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <a href="/haki/registration" class="btn btn-primary me-1">Daftar Baru</a>
              ...
              <template v-slot:[`item.action`]="{ item }">
                <ul class="list-unstyled hstack gap-1 mb-0">
                  <li v-if="item.status !==2 && item.status !==1" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Download">
                                      ...
                                      <li v-id="item.file" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Download">
                                        <a :href="item.file.String" class="btn btn-sm btn-soft-info"><i class="mdi mdi-file-outline"></i></a>
                                      </li>
